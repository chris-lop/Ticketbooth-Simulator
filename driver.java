...
// PROGRAM EXPLANATION
// This program simulates ticket booth operations and performs tickets and OPUS card transactions such as
// adding or removing new OPUS cards, listing the available tickets or OPUS cards, and much more. It also
// verifies the user input in order to ensure the right input is entered for most of the operations available.
...
public class driver {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			// Option 2: Asks user which ticket booth they wish to see the content of, and displays tickets and OPUS cards of chosen ticket booth.
			case "2":
				...
				while (loop) {
					...
					String boothNb;
					System.out.println("Which Ticketbooth do you want to see the content of? (Enter number 1 to 5):");
			...
			// Option 3: Compare all ticket booths and display those pairs that have same total tickets' amount along with the $ amount
			case "3":
				boolean pairs = true; 
				
				// If statements to compare all combinations of ticket booths based on total value
			...
			// Option 4: Compares all ticket booths and display the pairs that have the same ticket distribution
			case "4":
				boolean noPairs= true; 
				
				// If statements to compare all combinations of ticket booths based on ticket breakdown
				...
				// If statement that runs only if no ticket booths have the same ticket distribution
				if (noPairs == true)
			...
			// Option 5: Lists all ticket booth pairs that are equal based on the definition of equal in the class ticket booth
			case "5":
				boolean equal = true;
				System.out.println("List of Ticketbooths with same amount of tickets values and same number of OPUS cards:");
				System.out.println();
				
				// If statements to compare all combinations of ticket booths based on equals method in ticket booth class
				...
				if (equal == true)
					System.out.println("There are no ticketbooths with the same amount of tickets values and same number of OPUS cards");
				break;
			
			// Option 6: Ask the user which ticket booth they want to add an OPUS card to, as well as the OPUS card information, created the new OPUS card and adds it to the ticket booth
			case "6":
				...
				while (loop2) {
					...
					System.out.println("Which Ticketbooth do you want to add a OPUS card to? (Enter number 1 to 5):");
					boothNb = keyboard.next();
					switch(boothNb) {
			...
			// Option 7: Asks user which ticket booth they want to remove an OPUS card from, as well as the card index they want removed, and removes it from the booth
			case "7":
				// Inner loop to validate user input
				boolean loop3 = true;
				while (loop3) {
					
					// Switch case to determine which ticket booth user wants to remove an OPUS card from
					String boothNb;
					String cardNb;
					
					System.out.println("Which Ticketbooth do you want to remove an OPUS card from? (Enter number 1 to 5):");
					boothNb = keyboard.next();
					switch(boothNb) {
					...
					case "1":
						...
						if (booth1.opusCount() == 0) {
							...
							System.out.println("Enter card number you wish to remove (Enter card number from 0 to "+(booth1.opusCount()-1)+")");
					...
					case "2":
						...
						if (booth2.opusCount() == 0) {
							...
							// Asks which card the user wants to remove based on array index
							System.out.println("Enter card number you wish to remove (Enter card number from 0 to "+(booth2.opusCount()-1)+")");
							cardNb = keyboard.next();
					...
					case "3":
						...
						if (booth3.opusCount() == 0) {
							...
							// Asks which card the user wants to remove based on array index
							System.out.println("Enter card number you wish to remove (Enter card number from 0 to "+(booth3.opusCount()-1)+")");
							cardNb = keyboard.next();
					...
					case "4":
						...
						if (booth4.opusCount() == 0) {
							...
							// Asks which card the user wants to remove based on array index
							System.out.println("Enter card number you wish to remove (Enter card number from 0 to "+(booth4.opusCount()-1)+")");
							cardNb = keyboard.next();
					...
					case "5":
						...
						if (booth5.opusCount() == 0) {
							...
							// Asks which card the user wants to remove based on array index
							System.out.println("Enter card number you wish to remove (Enter card number from 0 to "+(booth5.opusCount()-1)+")");
							cardNb = keyboard.next();
			...
			case "8":
				...
				while (loop4) {
					...
					System.out.println("Which Ticketbooth do you want to update an OPUS card from? (Enter number 1 to 5):");
					boothNb = keyboard.next();
					switch(boothNb) {
					...
					case "1":
						...
						if (booth1.opusCount() == 0) {
							...
							while (true) {
								...
								System.out.println("Which card do you want to update? (Enter card number 0 to "+(booth1.opusCount()-1)+")");
								cardNb = keyboard.next();
								
								// If statement for input validation
								if (Integer.parseInt(cardNb) < 0 || Integer.parseInt(cardNb) > booth1.opusCount()-1) {
									System.out.println("Sorry, that is not a valid card, please try again.");
								} else {
									System.out.println("Enter new expiry month and year (seperate by a space): ");
					...
					case "2":
						...
						if (booth2.opusCount() == 0) {
							...
							while (true) {
								...
								String cardNb;
								int newMonth, newYear;
								System.out.println("Which card do you want to update? (Enter card number 0 to "+(booth2.opusCount()-1)+")");
								cardNb = keyboard.next();
								
								// If statement for input validation
								if (Integer.parseInt(cardNb) < 0 || Integer.parseInt(cardNb) > booth2.opusCount()-1) {
									System.out.println("Sorry, that is not a valid card, please try again.");
								} else {
									System.out.println("Enter new expiry month and year (seperate by a space): ");
									newMonth = keyboard.nextInt();
					...
					case "3":
						...
						if (booth3.opusCount() == 0) {
							...
							while (true) {
								...
								String cardNb;
								int newMonth, newYear;
								System.out.println("Which card do you want to update? (Enter card number 0 to "+(booth3.opusCount()-1)+")");
								cardNb = keyboard.next();
								
								// If statement for input validation
								if (Integer.parseInt(cardNb) < 0 || Integer.parseInt(cardNb) > booth3.opusCount()-1) {
									System.out.println("Sorry, that is not a valid card, please try again.");
								} else {
									System.out.println("Enter new expiry month and year (seperate by a space): ");
									newMonth = keyboard.nextInt();
					...
					case "4":
						...
						if (booth4.opusCount() == 0) {
							...
							while (true) {
								...
								String cardNb;
								int newMonth, newYear;
								System.out.println("Which card do you want to update? (Enter card number 0 to "+(booth4.opusCount()-1)+")");
								cardNb = keyboard.next();
								
								// If statement for input validation
								if (Integer.parseInt(cardNb) < 0 || Integer.parseInt(cardNb) > booth4.opusCount()-1) {
									System.out.println("Sorry, that is not a valid card, please try again.");
								} else {
									System.out.println("Enter new expiry month and year (seperate by a space): ");
									newMonth = keyboard.nextInt();
					...
					case "5":
						...
						if (booth5.opusCount() == 0) {
							...
							while (true) {
								...
								String cardNb;
								int newMonth, newYear;
								System.out.println("Which card do you want to update? (Enter card number 0 to "+(booth5.opusCount()-1)+")");
								cardNb = keyboard.next();
								
								// If statement for input validation
								if (Integer.parseInt(cardNb) < 0 || Integer.parseInt(cardNb) > booth5.opusCount()-1) {
									System.out.println("Sorry, that is not a valid card, please try again.");
								} else {
									System.out.println("Enter new expiry month and year (seperate by a space): ");
									newMonth = keyboard.nextInt();
			...
			// Option 9: Asks user which ticket booth's tickets they want to add, and the number of each tickets they want to add.
			...
			case "9":
				...
				while (loop5) {
					...
					case "1":
						...
						System.out.println("You now have "+booth1.addTickets(addRegular, addJunior, addSenior, addDaily, addWeekly));
						loop5 = false;
						break;
					...
					case "2":
						...
						addDaily = keyboard.nextInt();
						addWeekly = keyboard.nextInt();
						System.out.println("You now have "+booth2.addTickets(addRegular, addJunior, addSenior, addDaily, addWeekly));
						loop5 = false;
						break;
					...
					case "3":
						...
						addDaily = keyboard.nextInt();
						addWeekly = keyboard.nextInt();
						System.out.println("You now have "+booth3.addTickets(addRegular, addJunior, addSenior, addDaily, addWeekly));
						loop5 = false;
						break;
					...
					case "4":
						...
						addDaily = keyboard.nextInt();
						addWeekly = keyboard.nextInt();
						System.out.println("You now have "+booth4.addTickets(addRegular, addJunior, addSenior, addDaily, addWeekly));
						loop5 = false;
						break;
					...
					case "5":
						...
						addDaily = keyboard.nextInt();
						addWeekly = keyboard.nextInt();
						System.out.println("You now have "+booth5.addTickets(addRegular, addJunior, addSenior, addDaily, addWeekly));
						loop5 = false;
						break;
